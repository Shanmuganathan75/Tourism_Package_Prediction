...
DATASET_PATH = "hf://datasets/Shanmuganathan75/Tourism-Package-Prediction/tourism.csv"
TourData0 = pd.read_csv(DATASET_PATH)
print("Dataset loaded successfully.")

TourData1 = TourData0.drop(['CustomerID', 'Unnamed: 0'], axis=1)
